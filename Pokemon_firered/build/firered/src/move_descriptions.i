...
const u8 gMoveDescription_Supersonic[] = _("Start to practice\nviolin.\nIt may confuse the\nfoe.");
...
const u8 gMoveDescription_Growth[] = _("The user's body has\ngrown again,\nraising the SP.\nATK stat.");
...
const u8 gMoveDescription_DoomDesire[] = _("Attack after ten\nturns.");
